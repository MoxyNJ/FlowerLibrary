...
if session("user_id")<>"" then
    session("user_id") = ""  '如果已经用户登录，则删除用户登录记录。
    session.Abandon
else
'    session("return_asp")=""
end if
            ...
            <div class="row">
                ...
                <div class="loginbox_left">
                    ...
                    <div class="loginbox_input">
                        <form action="management_checkpass.asp" method="post">
                            <dl>
                                <dt>管理员ID：</dt>
                                <dd>
                    ...
                    <p style="visibility:hidden;">若您忘记了密码或会员ID，很抱歉，请到<a href="help/contact_us_7.asp">联系页面</a>与我们联系。我们会为您找回账号。</p>
                </div>
            </div>
