...
<head>
    ...
    <title>公司简介 - Flower Library</title>
</head>
                        ...
                        <div class="help-section">
                            <div class="help-area">
                                <div class="help-title">
                                    <h6>关于 Flower Library</h6>
                                </div>
                                <div class="help-box">
                                    <div class="main">

                                        <div class="company_profile step">
                                            <div class="row align-items-center">
                                                <div class="col-md-auto">
                                                    <div class="company_profile_title">
                                                        <p>■ 公司名称</p>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <p>Flower Library -鲜花图书馆-</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="company_profile step">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    <p>Shininge Ward Huangjia Shininge 2-6-28 1F，Shanghai 140-0002</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="company_profile step">
                                        ...
                                        <div class="company_profile step">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    <p>http://www.flowerlibrary.co.cn</p>
                                                </div>
                                            </div>
                                        </div>
